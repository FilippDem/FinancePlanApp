...
def combined_simulation_tab():
    ...
    # Lifetime Cashflow Visualization Section
    ...
    **Click on any year in the chart to see detailed income and expense breakdown.**
    ...
    if st.button("🐷 Calculate Lifetime Cashflow", type="primary", use_container_width=True, key="calc_cashflow_btn"):
    ...
    with cashflow_tab1:
        ...
        # Display chart
        selected_points = st.plotly_chart(fig_lc, use_container_width=True, on_select="rerun", key="cashflow_chart")
